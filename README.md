Psst: looking for [the scripts currently in development](https://github.com/lokka30/TheHallwayScripts/blob/dev/scripts/)? The ones in the main branch are older releases.
